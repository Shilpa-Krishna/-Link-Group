classpath:features/LinkgroupAsset.feature### selenium-cucumber-java
...
Fork / Clone repository from [here]( https://github.com/Shilpa-Krishna/selenium-cucumber-java-master) or download zip and set
...
- To run specific feature if you have multiple feature files use,
  `mvn test -Dcucumber.options="classpath:features/LinkgroupAsset.feature"`

### Reporters

Once you ran your tests you can generate the various types of reports. This framework `Link Group` uses
...
<img src="https://github.com/Shilpa-Krishna/selenium-cucumber-java-master/blob/master/src/main/resources/demo/demo.png" height="400px" width="600"/>
...
```
if you want to run only smoke tests then use only @smoke at tags section in RunnerTest.java.
...
[MIT](https://github.com/Shilpa-Krishna/selenium-cucumber-java-master/MIT-LICENSE.txt) 
